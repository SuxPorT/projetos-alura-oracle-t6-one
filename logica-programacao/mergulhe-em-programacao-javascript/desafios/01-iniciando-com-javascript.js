...
/*
  8. Use um prompt para perguntar o nome do usuário e armazená-lo na variável 
  nome.
*/
let nomeUsuario = prompt("Qual é o seu nome?");

/*
  9. Peça ao usuário para digitar sua idade usando um prompt e armazene-a na 
  variável idade.
*/
let idadeUsuario = Number(prompt("Digite a sua idade:"));

/*
  10. Agora, caso a idade seja maior ou igual que 18, exiba um alerta com a 
